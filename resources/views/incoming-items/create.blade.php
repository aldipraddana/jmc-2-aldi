    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('incoming.items.store') }}" class="js--form-submit" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-4">
                            ...
                            <select name="operator" class="form-control" id="">
                                ...
                                @foreach ($operator as $item)
                                    <option value="{{ Crypt::encrypt($item->id) }}">{{ strtoupper($item->name) }}</option>
                                @endforeach
                            </select>
                            @else
                                <select name="operator" class="form-control" @readonly(true) id="">
                                    <option value="{{ Crypt::encrypt(Auth::user()->id) }}">{{ strtoupper(Auth::user()->name) }}</option>
                                </select>
                            @endif
                        </div>
                    </div>
